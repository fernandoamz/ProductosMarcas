class MarcasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @marca.save
        format.html { redirect_to @marca, notice: 'Marca ha sido creado' }
  ...
  def update
    respond_to do |format|
      if @marca.update(marca_params)
        format.html { redirect_to @marca, notice: 'Marca ha sido actualizado ' }
  ...
  private
    ...
    def marca_params
      params.require(:marca).permit(:brand)
    end
end
